...
Use [this link](http://eda.seas.gwu.edu/2023-Fall/mini/US_State_Wind_Energy_Facts_2018.xlsx) to download the `US_State_Wind_Energy_Facts_2018.xlsx` file and put it in your `data_raw` folder. Here is some information on the data:
...
**Original source**: The primary source is the American Wind Energy Association (https://www.awea.org/), but the source for this particular data was found on [this article](https://github.com/emse-eda-gwu/2023-Fall/raw/main/mini/This%20Chart%20Shows%20Which%20States%20Produce%20the%20Most%20Wind%20Energy.pdf), which cites the AWEA.
