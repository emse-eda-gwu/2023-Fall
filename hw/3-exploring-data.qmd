...
3. Inside RStudio, open the ``r hw_file`` file, take notes, and write some example code as you go through the readings / exercises below.
...
- View a quick overview of many common plot types in [Wilke - 5: Directory of visualizations](https://serialmentor.com/dataviz/directory-of-visualizations.html).
- View the course site [help page](https://eda.seas.gwu.edu/2023-Fall/references.html#choosing-the-right-chart) on choosing the right chart.
