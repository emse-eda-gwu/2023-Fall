...
- **Use AI to Practice Reshaping Messy Data**: Open [ChatGPT](https://chat.openai.com/) and start a chat to practice the concept of tidying data into long and wide formats. Ask the AI questions about what it gives you to make sure you understand the concept. Are you certain the AI is giving you good code? Here is an example prompt (feel free to experiment with other prompts): 
...
Reflect on what you've learned while going through these readings and exercises. Is there anything that jumped out at you? Anything you found particularly interesting or confusing? Write at least a paragraph in your ``r paste0('hw', params$number, '.qmd')`` file.
