...
<img src="images/gleaves.png" width="300">
...
- Check out his team's [project](https://eda.seas.gwu.edu/showcase/2022-Fall/dc-vehicle-crashes.html) from 2022
...
## `r fa('globe')` Everything you need will be on the course website:<br>https://eda.seas.gwu.edu/2023-Fall/

--

## `r fa('calendar')` The [schedule](https://emse-eda-gwu.github.io/2023-Fall/schedule.html) is the best starting point
...
## 1) `r fa("book")` Weekly Homework / Readings: [HW1](https://eda.seas.gwu.edu/2023-Fall/hw/1-tidy-data.html)
...
## 3) `r fa("pen-ruler")` [Final Project](https://eda.seas.gwu.edu/2023-Fall/final/0-overview.html) 
...
<center>
<img src="https://eda.seas.gwu.edu/2023-Fall/figs/grade-breakdown-1.png" width=90%>
</center>
...
## `r fa('slack')` Use [Slack](https://emse-eda-f23.slack.com/) to ask questions.
...
## `r fa('slack')` [Slack](https://emse-eda-f23.slack.com/): See bb for link to join;<br>install on phone and **turn notifications on**!
...
1. If you haven't already, install everything on the [software page](https://eda.seas.gwu.edu/2023-Fall/software.html)

2. Stand up, meet each other, (maybe form teams?...use [this sheet](https://docs.google.com/spreadsheets/d/1r1hSkC8oql3aurOLUEmYfGovqEL5FYc9puAdNw1guJk/edit?usp=sharing)) 
